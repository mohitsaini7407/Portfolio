...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function (e) {
            ...
            fetch('https://formsubmit.co/ajax/mohitbanasya1@gmail.com', {
                method: 'POST',
                headers: {
                ...
                .then(async (response) => {
                    ...
                    if (!response.ok || result.success === false) throw new Error('Unable to send message');
                ...
                .catch(() => {
                    btn.innerHTML = '<span>Could Not Send</span> <i class="fa-solid fa-triangle-exclamation"></i>';
